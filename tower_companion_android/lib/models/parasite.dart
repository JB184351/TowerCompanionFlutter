class Parasite {
  ...
  Parasite silphicBladeSpinner = Parasite(
    "Silphic Bladespinner",
    bladeSpinner,
    silphic
  );

  Parasite silphicGoldSpinner = Parasite(
    "Silphic Goldspinner",
    goldSpinner,
    silphic
  );
  ...
  Map<String, String> positiveActiveSuffixes = {
    ...
    "Scrapfeeder": "Allows a consumable to be reused, deatches after first use",
    "Shatterskin": "Survive a killing blow, detaches afterwards",
    "Silverskin": "Discounts one item by 30%, detaches afterwards.",
    "Wireseeker": "Prevents an upcoming Malfunction or removes an existing Malfunction once, detaches afterward.",
  };
