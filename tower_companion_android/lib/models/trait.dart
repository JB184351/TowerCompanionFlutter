class Trait {
  ...
  Trait({required this.name, required this.traitDescription, required this.level});

  static String getWeaponTraitDescription(String weaponName, String trait) {
    switch (weaponName) {
      case "Dreadbound":
        return getWeaponTraitDescriptionForDreadbound(trait);
      case "Hollowseeker":
        return getWeaponTraitDescriptionForHollowseeker(trait);
      case "Rotgland Lobber":
        return getWeaponTraitDescriptionForRotglandLobber(trait);
      case "Electropylon Driver":
        return getWeaponTraitDescriptionForElectropylon(trait);
      case "Tachyomatic Carbine":
        return getWeaponTraitDescriptionForTachyomaticCarbine(trait);
      case "Thermogenic Launcher":
        return getWeaponTraitDescriptionForThermogenicLauncher(trait);
      case "Pyroshell Caster":
        return getWeaponTraitDescriptionForPyroshellCaster(trait);
      case "Coilspine Shredder":
        return getWeaponTraitDescriptionForCoilspineShredder(trait);
      case "Modified Sidearm SD-M8":
        return getWeaponTraitDescriptionsForPistol(trait);
      case "Spitmaw Blaster":
        return getWeaponTraitDescriptionForSpitMaw(trait);
      default:
        return "Couldn't get weapon trait description for $weaponName with $trait";
    }
  }

  static String getWeaponTraitDescriptionForDreadbound(String trait) {
    switch (trait) {
      case "Fourth Shard":
  ...
  static String getWeaponTraitDescriptionsForPistol(String trait) {
    switch (trait) {
      case "Homing Missile":
  ...
  // Define other `getWeaponTraitDescriptionForX` functions for different weapons in a similar manner.

  static List<String> getWeaponTraits(String weaponName) {
    switch (weaponName) {
      case "Modified Sidearm SD-M8":
  ...
  static String getWeaponTraitDescriptionForHollowseeker(String trait) {
  switch (trait) {
    case "Phasing Rounds":
    ...
    case "Split Stream":
      return "When this weapon is fired, an additional stream of homing shards is also fired.";
    case "Portal Beam":
...
static String getWeaponTraitDescriptionForRotglandLobber(String trait) {
  switch (trait) {
    case "Durable Rot":
...
static String getWeaponTraitDescriptionForCoilspineShredder(String trait) {
  switch (trait) {
...
static String getWeaponTraitDescriptionForElectropylon(String trait) {
  switch (trait) {
    ...
    case "Blade Pulse":
      return "Damaging enemies with a melee attack triggers a damaging pulse from nearby pylons.";
...
static String getWeaponTraitDescriptionForTachyomaticCarbine(String trait) {
  switch (trait) {
    case "Armor Piercing":
      return "Projectiles will pierce hostiles and ricochet off of surfaces.";
    case "Critical Hit":
    ...
    case "High Caliber":
      return "Higher damage at the expense of fire rate.";
    case "Rising Pitch":
    ...
    case "Accelerated":
      return "Kills decrease dash cooldown and increase fire rate.";
    default:
      return "Couldn't get weapon trait description";
  }
}

static String getWeaponTraitDescriptionForThermogenicLauncher(String trait) {
  switch (trait) {
    case "Easy to Use":
      return "Kills reward extra Proficiency.";
    case "Obolite Magnet":
...
static String getWeaponTraitDescriptionForPyroshellCaster(String trait) {
  switch (trait) {
    case "Streamlined Chamber":
...
static String getWeaponTraitDescriptionForSpitMaw(String trait) {
  switch (trait) {
    case "Wide Maw":
